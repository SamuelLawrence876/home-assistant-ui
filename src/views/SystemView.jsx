...
import { SamBoxStreamCard } from "../cards/system/SamBoxStreamCard.jsx";
...
export default function SystemView() {
  return (
    <div className="grid">
      ...
      <div className="col-6"><SamBoxStreamCard index={8} /></div>

      <div className="col-12"><ErrorLogCard index={9} /></div>
    </div>
  );
}
